...
f=open("D:/pythonwork/wordcloud/Test_word.txt","w")
tmrvl=[]
for page in range(1,200):
    url="https://movie.naver.com/movie/bi/mi/review.nhn?code=163608&page="+str(page)
...
# 이미지 파일위에 출력하기
img = Image.open('wordcloud/apple.png')
...
plt.axis("off")
plt.show()  
wordcloud.to_file("wordcloud/simple.png")
